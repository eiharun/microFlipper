 ...
 *      Author: harun
 *      Reference:https://github.com/flipperdevices/flipperzero-firmware/blob/dev/lib/drivers/cc1101_regs.h
 */

#ifndef INC_CC1101_REGS_H_
#define INC_CC1101_REGS_H_
