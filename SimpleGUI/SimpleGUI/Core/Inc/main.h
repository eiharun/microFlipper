...
#define OLED_Reset_GPIO_Port GPIOF
#define Up_BTN_Pin GPIO_PIN_13
#define Up_BTN_GPIO_Port GPIOF
#define Left_BTN_Pin GPIO_PIN_14
#define Left_BTN_GPIO_Port GPIOF
#define Back_BTN_Pin GPIO_PIN_15
#define Back_BTN_GPIO_Port GPIOF
#define Right_BTN_Pin GPIO_PIN_9
#define Right_BTN_GPIO_Port GPIOE
#define Down_BTN_Pin GPIO_PIN_11
#define Down_BTN_GPIO_Port GPIOE
#define Enter_BTN_Pin GPIO_PIN_13
#define Enter_BTN_GPIO_Port GPIOE
